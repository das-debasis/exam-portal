    ...
    <div className="bdy">
      <div className="landingpage">
        <div className="landtext">
          ...
          <span className="body">
            ...
            instructor, a clinician, a governing body, or a test provider. In
            some instances, the developer of the test may not be directly
                    ...
                    <th>
                      <div>
                        <h4>
                          ...
                          Coaching ClassNamees
                        </h4>
                        <p style={{ padding: "0px 30px" }}>
                          Coaching classNamees conducting weekly tests for
                          students preparing for competetive exams like JEE,
                          NEET, CET etc.,
                        </p>
                      </div>
                    </th>
                    ...
                    <th>
                      <div>
                        ...
                        <p style={{ padding: "0px 30px" }}>
                          ...
                          evaluations with an optional proctored exam
                          environment
                        </p>
                      </div>
                    </th>
      ...
      <footer className="ftrr">
        <center>
          ...
          <p>
            <a href="mailto:hege@example.com">eexamportal@education.in</a>
          </p>
        </center>
      </footer>
    </div>
